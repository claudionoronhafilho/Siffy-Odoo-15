     ...
     patch(NavBar.prototype, "theme_backend.MenuJs", {
         async setup(parent, menuData) {
            ...
            //  useListener('click', '.lang_selector', this._GetLanguages);
             ...
             useListener('click', '.o_menu_sections .o_menu_entry_lvl_2, .mobile_menu_sections .dropdown-item, .o_menu_sections .o_nav_entry', this._childMenuClick);
            ...
            //  useListener('hideen.bs.modal', '#search_bar_modal', this._searchModalReset);
             ...
             useListener('click', '.header_to_do_list .to_do_list', this._openToDoList);
        ...
        //  },
         ...
         _searchPages: function(){
            ...
            // active First result from the searched list
             $(this.$search_modal_results.find('.search_list_content')[0]).addClass('navigate_active');
         },
